...
class MyWorkflow(sciluigi.WorkflowTask):
    ...
    # helix_seq subsets
    helix_contexts_filename = luigi.Parameter(default=seq_params_dir+'helix_seqs_10.dat')
    helix_contexts_filename = luigi.Parameter(default=seq_params_dir+'helix_seqs_1.dat')

    # tar junction subsets
    tar_1_filename = luigi.Parameter(default=seq_params_dir+'tarjunctions_expt1.dat')
    tar_2_filename = luigi.Parameter(default=seq_params_dir+'tarjunctions_expt2.dat')
    tar_3_filename = luigi.Parameter(default=seq_params_dir+'tarjunctions_expt3.dat')
    
    # others
    tlr_filename = luigi.Parameter(default=seq_params_dir+'receptor_11nt.dat')
    base_filename = luigi.Parameter(default=seq_params_dir+'base_1.dat')
