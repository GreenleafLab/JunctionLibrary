...
if __name__ == '__main__':
    ...
    saveDir = '150311_library_v2/along_extended'
    ...
    lengths = [8, 9, 10, 11]
    offsetsPerLength = {8:[-3, 3], 9:[-3,4], 10:[-4,4], 11:[-4, 5]}
    filenames = {}
    ...
    subset = allSeqs.loc[(allSeqs.loc[:, 'no_flank'] == 'A_')&(allSeqs.loc[:, 'flank'] == 'CG')&(allSeqs.loc[:, 'side'] == 'up')]
