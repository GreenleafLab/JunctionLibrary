...
# initialize file
filename = os.path.join(wd, 'all3x3junctions.04_double_double.fasta')
...
for helixSequence in helices:
    ...
    f.write('>%s\n'%name)
    sequenceList = create_library.doubleDoubleJunctionOrder(helixSequence,
                                                      junctionSequence,
