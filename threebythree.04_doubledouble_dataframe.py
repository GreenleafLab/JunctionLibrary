...
# initialize file
filename = os.path.join(wd, 'all3x3junctions_NB.04_double_double.txt')
print 'saving to %s'%filename
f = open(filename, 'w')

filename2 = os.path.join(wd, 'all3x3junctions_NB.04_double_double_characterization.txt')
f2 = open(filename2, 'w')

# initialize counts
count = 1
#initilalize dataframe just to add header
...
count = create_library_dataframe.saveSequenceDoubleDouble([helixName, receptorName, loopName],
                             sequences,
                             helices,
